...
#include "../../potIncicator-qt/serialreader.h"
...
QT_MOC_LITERAL(1, 13, 16), // "potValueReceived"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5), // "value"
QT_MOC_LITERAL(4, 37, 11) // "onReadyRead"

    },
    "SerialReader\0potValueReceived\0\0value\0"
    "onReadyRead"
};
...
void SerialReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SerialReader *_t = static_cast<SerialReader *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->potValueReceived((*reinterpret_cast< quint16(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SerialReader::*)(quint16 );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SerialReader::potValueReceived)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SerialReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SerialReader.data,
      qt_meta_data_SerialReader,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SerialReader::potValueReceived(quint16 _t1)
{
